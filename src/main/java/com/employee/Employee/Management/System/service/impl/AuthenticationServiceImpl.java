...
import com.employee.Employee.Management.System.config.JwtService;
...
import com.employee.Employee.Management.System.entity.Token;
import com.employee.Employee.Management.System.entity.User;
import com.employee.Employee.Management.System.repository.TokenRepository;
...
import com.employee.Employee.Management.System.enums.TokenType;
...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    public AuthenticationResponse register(RegisterDto request) {
        ...
        var userExists = repository.findByEmail(request.getEmployeeEmail())
                .isPresent();

        if (userExists) {
            throw new IllegalStateException("User with email " + request.getEmployeeEmail() + " already exists");
        }
